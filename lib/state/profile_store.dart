...
class ProfileStore extends Notifier<UserProfile> {
  ...
  UserProfile build() {
    return const UserProfile(
      ...
      pronouns: 'they/them',
      bio:
          'using autocorrect to make my life more interesting, and my bio is a reflection of that. lmao i love cats, coding, and cozy spaces. i also enjoy taking photos of my cat while coding in cozy spaces... and i love to share my photos with the world. i hope you enjoy them as much as i do. 🐱 💻☕',
